...
export function ProductsFeature() {
  return (
    <section className="relative flex min-h-130 items-center overflow-hidden bg-[#001428] lg:min-h-197">
      ...
      >
        <div className="rounded-2xl bg-white p-6 shadow-2xl sm:rounded-3xl sm:p-8 md:p-16 lg:max-w-149">
          ...
          <ul className="mt-8 space-y-4">
            {productChecklist.map((line) => (
              <li
                key={line}
                className="flex gap-3 text-sm font-semibold text-[#023048]"
              >
                <span
        ...
        <div className="relative mt-0 hidden min-h-95 overflow-hidden rounded-3xl lg:mt-0 lg:block lg:aspect-auto">
          <MarketingImage
