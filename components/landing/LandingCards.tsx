    ...
    <div className="relative z-20 -mt-12 sm:-mt-20">
      <div className={sectionInner}>
        <div className="grid grid-cols-1 gap-4 sm:grid-cols-3 sm:items-stretch">
          <div className="relative flex min-h-28 rounded-lg bg-linear-to-b from-[#30EAA9] to-[#0798E7] p-0.5 shadow-xl">
            <div className="flex min-h-0 flex-1 items-center gap-4 rounded-md bg-white/95 p-6">
              <MarketingImage
          ...
          <div className="flex min-h-28 flex-col justify-center rounded-lg bg-linear-to-br from-[#30EAA9] to-[#0798E7] px-6 py-8 text-center text-white shadow-xl">
          ...
          <div className="relative flex min-h-28 rounded-lg bg-linear-to-b from-[#30EAA9] to-[#0798E7] p-0.5 shadow-xl">
            <div className="flex min-h-0 flex-1 items-center gap-4 rounded-lg bg-white/95 p-6">
              <MarketingImage
